  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <motion.div 
        ...
        style={{ maxWidth: '720px', width: '100%', padding: '40px', background: '#FFFFFF' }}
      >
        {onClose && (
          <button className="modal-close-btn" onClick={onClose} style={{ background: '#E2E8F0', color: '#0F172A' }}>
            <X size={20} />
          </button>
        )}
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '8px' }}>
          ...
          <span style={{ fontFamily: 'var(--font-mono)', fontSize: '12px', color: 'var(--brand-green)', fontWeight: '800', textTransform: 'uppercase' }}>
          ...
          {Object.keys(categories).map(catKey => (
            <button
              ...
              style={{
                ...
                background: category === catKey ? 'var(--brand-green)' : '#F1F5F9',
        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', gap: '12px' }}>
            ...
            />
            <button type="submit" className="btn-v4 btn-v4-emerald" style={{ padding: '14px 28px' }}>
